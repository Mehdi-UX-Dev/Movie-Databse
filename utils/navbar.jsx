...
function Navbar() {
  ...
  const handleHover = (type) => {
    if (type == "movie")
      setVisiblity({ ...visiblity, movieVisible: !visiblity.movieVisible });
    if (type == "tvshow")
      setVisiblity({ ...visiblity, tvVisible: !visiblity.tvVisible });
  };
  ...
  return (
    <div className="flex bg-darkBlue p-2 w-full justify-between ">
      <div className="flex">
        ...
        {/* movie's section */}
        <div
          className="realtive mt-2 mr-3 z-10"
          onMouseOver={() => handleHover("movie")}
          onMouseOut={() => handleHover("movie")}
        >
          {/* button */}
          <div className=" ">
          ...
          {/* links  */}
          <div
            className="absolute  w-24 bg-gray-100 rounded divide-y-2 divide-slate-300"
            hidden={visiblity.movieVisible}
          >
        ...
        {/* tv's section */}
        <div
          className="realtive mt-2 ml-5 divide-y-2 z-10"
          onMouseOver={() => handleHover("tvshow")}
          onMouseOut={() => handleHover("tvshow")}
        >
          {/* button */}
          <div>
          ...
          {/* links  */}
          <div
            className="absolute bg-gray-200 divide-y-2 divide-slate-300 w-24 rounded"
            hidden={visiblity.tvVisible}
          >
